...
;  <2 CHAR # OF DEATHS WITH 100 BIT ON>"""
 ...
 #           time.sleep(1)
    ...
    def move_forward(self):
        ...
        # I don't think that's right. wireshark indicates \x69 or ASCII i dec 105

        #self.send_key(0o206)  # Up arrow - octal 206

        key=103+self.player_number # i for player 1, j for player 2
    ...
    def turn_left(self):
        ...
        #wireshark indicates 19 or 11 hex. guessing 19 (23 decimal)

        #That's for the first player. Subsequent player is 1 more

        key = 21+self.player_number
